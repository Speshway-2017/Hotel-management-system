...
function AddCoupon() {
  ...
  // Demo discount calculation for live preview
            ...
            <div className="p-5 space-y-5 bg-navy/[0.02]">
              ...
              <div className="p-4 rounded-xl bg-purple/5 border border-purple/10 space-y-2 text-xs text-navy/80 text-left">
                <p className="font-bold text-purple flex items-center gap-1.5">
                  <CheckCircle2 className="size-4" /> Validation Rules Applied
                </p>
                <ul className="space-y-1 text-[11px] text-muted-foreground list-disc list-inside">
                  <li>Applicable strictly for direct website bookings.</li>
                  <li>Automatically validated by the backend before payment.</li>
                  <li>Hidden from Admin, Manager & Receptionist manual bookings.</li>
                </ul>
              </div>
            </div>
          </Panel>
