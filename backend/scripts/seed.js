...
const SEED_USERS = [
  ...
  { name: 'Abhi', email: 'abhi@gmail.com', password: 'abhi123', role: 'guest', mobile: '4565342635' },
  ...
  { name: 'Sunny', email: 'sunny@gmail.com', password: 'password123', role: 'guest', mobile: '9876543210' },
...
const SEED_BOOKINGS = [
  { bookingId: 'BK-20101', guest: 'Sunny', phone: '4563536437', email: 'sunny@gmail.com', room: '101 · Standard Room', roomNumber: '101', roomType: 'Standard Room', checkIn: '2026-09-22', checkOut: '2026-09-24', nights: 2, pax: '1 Adult', source: 'Hour Stay App', status: 'Checked-in', amount: 9500, totalAmount: 9500, balance: 0, paymentStatus: 'Paid', propertyId: 'HS-JAI' },
  { bookingId: 'BK-10101', guest: 'Mounika', phone: '+91 99443 88120', email: 'mounika@gmail.com', room: '102 · Standard Room', roomNumber: '102', roomType: 'Standard Room', checkIn: '2026-09-22', checkOut: '2026-09-24', nights: 2, pax: '2 Adults', source: 'MakeMyTrip', status: 'Checked-in', amount: 11400, totalAmount: 11400, balance: 0, paymentStatus: 'Paid', propertyId: 'HS-JAI' },
  { bookingId: 'BK-10102', guest: 'Mani', phone: '+91 98765 43210', email: 'mani@gmail.com', room: '103 · Standard Room', roomNumber: '103', roomType: 'Standard Room', checkIn: '2026-09-18', checkOut: '2026-09-21', nights: 3, pax: '2 Adults', source: 'Direct Web', status: 'Checked-out', amount: 8500, totalAmount: 8500, balance: 0, paymentStatus: 'Paid', propertyId: 'HS-JAI' },
  { bookingId: 'BK-10301', guest: 'Surya', phone: '+91 47362 54654', email: 'surya@gmail.com', room: '103 · Standard Room', roomNumber: '103', roomType: 'Standard Room', checkIn: '2026-09-24', checkOut: '2026-09-26', nights: 2, pax: '2 Adults', source: 'Direct Web', status: 'Confirmed', amount: 8500, totalAmount: 8500, balance: 0, paymentStatus: 'Paid', propertyId: 'HS-JAI' },
  { bookingId: 'BK-10202', guest: 'Vamsi', phone: '+91 98765 10202', email: 'vamsi@gmail.com', room: '102 · Standard Room', roomNumber: '102', roomType: 'Standard Room', checkIn: '2026-09-25', checkOut: '2026-09-27', nights: 2, pax: '2 Adults', source: 'Direct Web', status: 'Confirmed', amount: 7000, totalAmount: 7000, balance: 0, paymentStatus: 'Paid', propertyId: 'HS-JAI' },
  { bookingId: 'BK-30101', guest: 'Sai', phone: '+91 98765 10404', email: 'sai@gmail.com', room: '301 · Executive Suite', roomNumber: '301', roomType: 'Executive Suite', checkIn: '2026-09-26', checkOut: '2026-09-28', nights: 2, pax: '2 Adults', source: 'Booking.com', status: 'Confirmed', amount: 21000, totalAmount: 21000, balance: 0, paymentStatus: 'Paid', propertyId: 'HS-JAI' }
];
